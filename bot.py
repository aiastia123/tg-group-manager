...
async def post_init(application):
    ...
    group_commands = [
        ...
        BotCommand("whoinvited", "查看邀请来源"),
        BotCommand("del", "删除消息"),
        BotCommand("pin", "置顶消息"),
        BotCommand("unpin", "取消置顶"),
        BotCommand("unpinall", "取消所有置顶"),
        BotCommand("announce", "发布群公告"),
        BotCommand("settings", "群组设置"),
        BotCommand("setconfig", "修改配置项"),
        BotCommand("rules", "查看群规"),
        BotCommand("setrules", "设置群规"),
        BotCommand("info", "用户信息"),
        BotCommand("note", "设置用户备注"),
        BotCommand("tags", "设置用户标签"),
        BotCommand("setadmin", "设置管理员"),
        BotCommand("admins", "管理员列表"),
        BotCommand("addperm", "追加管理员权限"),
        BotCommand("delperm", "移除管理员权限"),
        BotCommand("perms", "查看用户权限"),
        BotCommand("blacklist", "加入黑名单"),
        BotCommand("unblacklist", "移出黑名单"),
        BotCommand("blacklists", "查看黑名单"),
        BotCommand("addword", "添加敏感词"),
        BotCommand("delword", "删除敏感词"),
        BotCommand("words", "敏感词列表"),
        BotCommand("reports", "查看举报列表"),
        BotCommand("resolve", "处理举报"),
